...
// ✅ Show SweetAlert2 After Successful Deletion
document.addEventListener('swal:deleted', event => {
    Swal.fire({
...
// ✅ Show SweetAlert2 After Successful Update
document.addEventListener('swal:updated', event => {
    Swal.fire({
        title: event.detail.title,
        text: event.detail.text,
        icon: event.detail.icon,

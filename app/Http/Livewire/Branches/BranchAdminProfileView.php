...
class BranchAdminProfileView extends Component
{
    use WithFileUploads;
    use WithPagination;
    ...
    public function UpdateProfile()
    {
        ...
        return redirect()->route('branch_admin.profile_view')->with($notification);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.branches.branch-admin-profile-view', ['profiledata' => $this->profiledata]);
    }

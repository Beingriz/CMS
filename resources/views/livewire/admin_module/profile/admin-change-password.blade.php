                                    ...
                                    <div>
                                        @csrf
                                            ...
                                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                                ...
                                                <a href="{{route('admin.logout')}}" class="text-muted">Do you want to Re-Login?</a>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="password"  wire:model.lazy="old_password"placeholder="Old Password" id="old_passowrd">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="password"  wire:model="new_password"placeholder="New Password" id="new_passowrd">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="password"  wire:model="confirm_password"placeholder="Confirm Password" id="confirm_passowrd">
                                                    <span class="error">@error('confirm_password'){{$message}}@enderror</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="card-body">
                                        <a href="#" wire:click="ChangePassword()" class="btn btn-info btn-rounded waves-effect waves-light">Change Password</a>
                                    </div>

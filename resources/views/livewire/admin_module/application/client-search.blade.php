    ...
    @if (count($RegisteredClient)==0 || $Form_View == 1)
        <div class="form-data">
                ...
                <div class="col-55">
                    <div class="md-form">
                        <input type="text" id="Email_ID" name="Email_ID" class="form-control"
                            ...
                            @error('Email_ID') <span class="error">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
            <!-- DOB -->
                ...
                <div class="col-55">
                    <div class="md-form">
                        <textarea type="number" id="Address" name="Address" class="form-control"
                            placeholder="Address" wire:model.lazy="address" ></textarea>
            ...
            <div class="row"> {{--Thumbnail--}}
                ...
                <div class="col-55">
                    <div class="md-form">
                        <input type="file"  wire:model="Profile_Image" name="Profile_Image" class="form-control" id="Profile_Image{{ $iteration }}"  accept="image/*">
            ...
            @if (!is_Null($Profile_Image))
                <div class="row">
                    <div class="col-45">
                        <img class="col-75" src="{{ $Profile_Image->temporaryUrl() }}"" alt="Profile_Image" />
                    </div>
                </div>
            ...
            <div class="form-data-buttons">
                ...
                <div class="row">
                    <div class="col-100">
                        ...
                        <a href="" class="btn btn-success btn-rounded btn-sm" wire:click.prevent ="UpdateClientDetails('{{ $data->Id }}')" onclick="confirm('Are you sure you want to Update the Details?') || event.stopImmediatePropagation()">Update</a>
                        @endforeach
                        @endif
           ...
           {{-- Profile Image --}}
            <div class="row">
                ...
                <div class="col-55">
                    <div class="row">
                        <div class="col-55">
                            <img class="profile_image" src="{{ $data->Profile_Image }}" alt="Profile" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="show">
                                <a href="" class="btn btn-primary btn-rounded btn-sm" wire:click.prevent ="EditClientDetails('{{ $data->Id }}')" onclick="confirm('Are you sure you want to Edit Client Details?') || event.stopImmediatePropagation()">Edit</a>
                        </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="right-menu">
                ...
                <div class="form-insight-section" >
                    ...
                    <div class="form-sec-data">
                        ...
                        <p class="section-value"><span style="color:red">{{$UnReg_Rev}}</span> <br> Revenue from Unregistered Clients</p>

            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <label for="example-text-input" class="col-sm-4 col-form-label">{{$DS_Id}}</label>
                        </div>
                    </div>
                    ...
                    @if ($Type =='Main Category') {{--Main Category Fields--}}
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  wire:model.lazy="Name"  name="CategoryName" class="form-control"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <select name="CategoryType" id="CategoryType" wire:model="CategoryType" class="form-control">
                                ...
                                <span class="error">@error('CategoryType'){{$message}}@enderror</span>
                            </div>
                        </div>
                        {{$pos}}
                        <div class="row mb-3">
                    ...
                    @if ($Type =='Sub Category') {{--Sub Category Fields--}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="number" id="Loan_Amount" wire:model="Loan_Amount"  name="Loan_Amount" class="form-control"
                                    placeholder="Loan_Amount" pattern="[0-9]">
                                <span class="error">@error('Loan_Amount'){{$message}}@enderror</span>
                            </div>
                            <div class="col-sm-2">
                                <input type="number" id="Tenure"  wire:model="Tenure"  name="Tenure" class="form-control"
                                    placeholder="Tenure" pattern="[0-9]">
                                <span class="error">@error('Tenure'){{$message}}@enderror</span>
                            </div>
                            <div class="col-sm-3">
                                <input type="number" id="Unit_Price" wire:model="Unit_Price"  name="Unit_Price" class="form-control"
                                placeholder="Price">
                    ...
                    <div class="form-data-buttons"> {{--Buttons--}}
                        <div class="row">
                            ...
                            @elseif($Update == 1)
                                <a href='#' wire:click.prevent="UpdateMain('{{$DS_Id}}')" class="btn btn-success btn-rounded btn-sm">Update</a>
                                <a href="{{route('DebitSource')}}"  class="btn btn-info btn-rounded btn-sm">Reset</a>
                                <a href="{{route('dashboard')}}" class="btn btn-rounded btn-warning btn-sm">Cancel</a>
                            @elseif($Update == 2)
                                <a href='#' wire:click.prevent="UpdateSub('{{$DS_Id}}')" class="btn btn-success btn-rounded btn-sm">Update</a>
                                <a href="{{route('DebitSource')}}"  class="btn btn-info btn-rounded btn-sm">Reset</a>
                                <a href="{{route('dashboard')}}" class="btn btn-rounded btn-warning btn-sm">Cancel</a>
                            @endif
                            </div>

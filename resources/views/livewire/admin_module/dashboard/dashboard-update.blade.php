                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Conversion : {{$item->Conversion }}</p>
                                        ...
                                        <a href="{{route('send.message',[$item->Phone_No,$item->Name, $item->Service,\Carbon\Carbon::parse($item->created_at)->diffForHumans(),'Enquiry'])}}"  data-bs-placement="top" data-bs-toggle="tooltip"  class="btn btn-sm btn-rounded btn-success"  data-bs-original-title="Send Whatsapp Message to {{$item->Name}}" aria-label="Info" >Whatsapp</a>

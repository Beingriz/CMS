                        ...
                        <form>
                            <div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text"
                                            wire:model="video_url"placeholder="Video URL" id="video_url">
                                        <span class="error">
                                            @error('video_url')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="file" wire:model="slide_image"
                                            id="slide_image">
                                    </div>
                                </div>
                                ...
                                @if (!is_Null($slide_image))
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img class=" rounded avatar-lg" src="{{ $slide_image->temporaryUrl() }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <img class=" rounded avatar-lg"
                                                src="{{ asset('storage/' . $old_slide_image) }}" alt="" />
                                        </div>
                                    </div>
                                @endif
                            </div>
                            <div class="card-body">
                                <a href="#" wire:click="UpdateSlide('1')"
                                    class="btn btn-info btn-rounded waves-effect waves-light">Update Slide</a>
                            </div>
                            ...
                            <tbody>
                                @foreach ($home_slide as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" wire:click.prevet="Fetch('{{ $data['id'] }}')"

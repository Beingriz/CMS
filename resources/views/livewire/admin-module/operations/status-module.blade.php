                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="Save">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="Statusfor" wire:model="Relation" name="Relation"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text" placeholder="Status Name" wire:model="Name"
                                    id="Name">
                                <span class="error">
                                    @error('Name')
                                        {{ $message }}
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">#{{ $Existing_st->total() }} Status for {{ $Relation }} Category
                        </h5>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <tbody>
                                    @foreach ($Existing_st as $key)
                                        <tr>
                                            ...
                                            <td>
                                                <img class="avatar-sm" src="{{ asset('storage/' . $key->Thumbnail) }}"
                                                    alt="">
                                            </td>
                                            <td>
                                                <a href="{{ route('edit.status', $key->Id) }}" title="Edit"
                                                    class="btn btn-sm btn-primary font-size-15" id="editData"><i
                                                        class="mdi mdi-circle-edit-outline"></i></a>
                                                <a href="{{ route('delete.status', $key->Id) }}" title="Delete"
                                                    class="btn btn-sm btn-danger font-size-15" id="delete"><i
                                                        class=" mdi mdi-trash-can"></i></a>
                                                <a href="#"
                                                    wire:click.prevent = "ViewStatus('{{ $key->Status }}')"title="View List"
                                                    class="btn btn-sm btn-info font-size-15"><i
                                                        class="mdi mdi-view-grid-plus"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-md-8">
                                    <p class="text-muted">Showing {{ count($Existing_st) }} of
                                        {{ $Existing_st->total() }} entries</p>
                                </div>
                                <div class="col-md-4">
                                ...
                                <p class="card-text"><small class="text-muted">Last status
                                        {{ $created }}</small></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                    ...
                                    @forelse($records as $data)
                                        <tr>
                                            ...
                                            <td> <img
                                                    ...
                                                    alt="avatar-4" class="rounded-circle avatar-md"></td>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-md-8">
                                    <p class="text-muted">Showing {{ count($records) }} of {{ $records->total() }}
                                        entries</p>
                                </div>
                                <div class="col-md-4">
                                    <span class=" pagination pagination-rounded float-end">

                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <label for="example-text-input"
                                class="col-sm-4 col-form-label">{{ $Id }}</label>
                        </div>
                    </div>
                    <form wire:submit.prevent="Save">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="Branch" wire:model="Branch"
                                    name="Particular">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <textarea id="address" wire:model.lazy="Address" name="Address" class="form-control"
                                    placeholder="eployee current address" rows="3" resize="none"></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="Experience" wire:model.lazy="Experience"
                                    name="Experience">
                                    <option value="">---Select---</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <div class="md-form">
                                    <input type="file" id="Qualification_Doc{$itteration}" wire:model="Qualification_Doc"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                            <div class="md-form">
                                <input type="file" id="Resume_Doc{$itteration}"wire:model="Resume_Doc"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <div class="md-form">
                                    <input type="file" id="Profile_Img{$itteration}" wire:model="Profile_Img"
                        ...
                        @if (!is_Null($Profile_Img))
                            <div class="row">
                                <div class="col-45">
                                    <img class="col-75" src="{{ $Profile_Img->temporaryUrl() }}""
                                        alt="profile image" />
                                </div>
                            </div>
                        @elseif(!is_Null($Old_Profile_Img))
                            <div class="row">
                                <div class="col-45">
                                    <img class="col-75" src="{{ url('storage/' . $Old_Profile_Img) }}""
                                        alt="existing image" />
                                </div>
                            </div>
                        @endif

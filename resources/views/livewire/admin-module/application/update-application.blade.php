<div> {{-- Livewire Starts. --}}
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('new.application') }}">New Form</a></li>
                            ...
                            <div class="col-lg-8">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" placeholder="Mobile Number"
                                        id="progress-basicpill-phoneno-input" wire:model.debounce.600ms="Mobile_No">
                                    @error('Mobile_No')
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <a href="#" class="btn btn-primary waves-effect waves-light"
                                        wire:click="Search('{{ $Mobile_No }}')">Search</a>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="row">{{-- Start of Search Result Row. --}}
        @if ($Records_Show == 'Enable')
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">{{ $AppliedServices->total() }} Records for {{ $C_Mob }} of
                            {{ $C_Name }}</h5>
                    </div>
                    <div class="row no-gutters align-items-center">
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-muted">Last Application Applied
                                    ...
                                    @foreach ($AppliedServices as $key)
                                        ...
                                        <tr class='{{ $key->Class }}'>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-sm btn-danger font-size-15"
                                                    id="delete"><i class="mdi mdi-delete-outline"></i></a>
                                                <a href="#" class="btn btn-sm btn-primary font-size-15"
                                                    id="open"><i class="mdi mdi-book-open-page-variant"></i></a>
                                            </td>

<div>
    <div class="table-container">
        ...
        <div class="table-information">
            <span class="info-text"> {{ $sl_no }} Applications {{ $ChangeStatus }} as on
                {{ date('d-m-Y') }}</span>
                        ...
                        <div>
                            <div class="d-flex align-items-center ml-4">
                                ...
                                @if (count($Checked_Id) > 0)
                                    <label for="date" class="text-nowrap mr-2 mb-0">Change Status of
                                        {{ count($Checked_Id) }} Applications to</label>

                                    <select class="form-control form-control-sm" id="multiplestatusupdate"
                                        name="multiplestatusupdate"
                                        wire:change="MultipleStatusUpdate($event.target.value)">
            ...
            <tbody>
                @foreach ($app_list as $data)
                    <tr>
                        ...
                        <td><input type="checkbox" name="checked" id="checked" value="{{ $data->Id }}"
                                wire:model="Checked_Id"></td>

        ...
        <div class="insight-container">
            ...
            <div class="right-menu-section">
                ...
                <div class="sec-data">
                    ...
                    <p class="section-pre-values">Paid <span> &#x20B9;{{ $paid }}</span> Balance <span>
                            &#x20B9;{{ $balance }}</span></p>
        ...
        <div class="form-data-container">
            <div class="form-data">
                <form action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-55">
                            <a href="/digital/cyber/download_ack/{{ $Id }}"
                                class="label">{{ $Ack_No }}</a>
                        </div>
                    </div>
                    <!-- Document No -->
                    <div class="row">
                        ...
                        <div class="col-55">
                            <a href="/digital/cyber/download_doc/{{ $Id }}"
                                class="label">{{ $Document_No }}</a>
                        </div>
                    </div>
                    <!-- Name -->
                    <div class="row">
            ...
            <div class="form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-55">
                        <a href="/digital/cyber/download_pay/{{ $Id }}"
                            class="label">{{ $PaymentMode }}</a>
                    </div>
                </div>
                <!-- Updated on -->
                <div class="row">
            ...
            <table>
                ...
                <tbody>
                    @foreach ($show_app as $data)
                        <tr>
                            <td class="show">{{ $n++ }}</td>
                            <td class="show"><input type="checkbox" id="checkbox" name="checkbox"

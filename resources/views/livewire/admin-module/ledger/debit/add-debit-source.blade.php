        ...
        <div class="col-lg-5">
            <div class="card">
                <div class="card-header d-sm-flex align-items-center justify-content-between"">
                    <h5>Debit Ledger</h5>
                    <h5><a href="{{ route('DebitSource') }}" title="Click here for New Debit Source">New Entry</a></h5>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="Save">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <label for="example-text-input"
                                    class="col-sm-4 col-form-label">{{ $DS_Id }}</label>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <select name="Type" id="type" wire:model="Type"
                                    wire:change="Change($event.target.value)" class="form-control">
                        ...
                        @if ($Type == 'Main Category') {{-- Main Category Fields --}}
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" wire:model.lazy="Name" name="CategoryName"
                            ...
                            <div class="row mb-3">
                                <label for="Date" class="col-sm-4 col-form-label">Type</label>
                                <div class="col-sm-8">
                                    <select name="CategoryType" id="CategoryType" wire:model="CategoryType"
                                        class="form-control">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="md-form">
                                        <input type="file" id="Thumbnail{{ $iteration }}" wire:model="Image"
                                            accept=".jpg,.png" name="Thumbnail" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-55">
                                    ...
                                    @elseif(!is_null($OldImage))
                                        <div class="md-form">
                                            <img class="col-75"
                                                src="{{ !empty($OldImage) ? url('storage/' . $OldImage) : url('storage/no_image.jpg') }}">
                                        </div>
                                    @endif
                                </div>
                        ...
                        @if ($Type == 'Sub Category') {{-- Sub Category Fields --}}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select name="CategoryList" id="CategoryList" wire:model="CategoryList"
                                        wire:change="ResetList($event.target.value)" class="form-control">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="Source_Name" wire:model.lazy="SubCategoryName"
                                        name="Source_Name" class="form-control" placeholder="Sub Category Name">
                                    <span class="error">
                            ...
                            @if ($CategoryType == 'Expenses')
                                <div class="row mb-3">{{-- Unit Price --}}
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" id="Unit_Price" wire:model="Unit_Price"
                                            name="Unit_Price" class="form-control" placeholder="Price">
                                        <span class="error">
                                            @error('Unit_Price')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" id="Loan_Amount" wire:model="Loan_Amount"
                                            name="Loan_Amount" class="form-control" placeholder="Loan_Amount"
                                            pattern="[0-9]">
                                        <span class="error">
                                            @error('Loan_Amount')
                                                {{ $message }}
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" id="Tenure" wire:model="Tenure" name="Tenure"
                                            class="form-control" placeholder="Tenure" pattern="[0-9]">
                                        <span class="error">
                                            @error('Tenure')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="col-100">
                                    @if ($Update == 0)
                                        ...
                                        @if ($Type == 'Main Category')
                                            <a href='#' wire:click.prevent="ResetMainFields()"
                                    ...
                                    @elseif($Update == 1)
                                        <a href='#' wire:click.prevent="UpdateMain('{{ $DS_Id }}')"
                                            class="btn btn-success btn-rounded btn-sm">Update</a>
                                        <a href="{{ route('DebitSource') }}"
                                            class="btn btn-info btn-rounded btn-sm">Reset</a>
                                        <a href="{{ route('admin.home') }}"
                                            class="btn btn-rounded btn-warning btn-sm">Cancel</a>
                                    @elseif($Update == 2)
                                        <a href='#' wire:click.prevent="UpdateSub('{{ $DS_Id }}')"
                                            class="btn btn-success btn-rounded btn-sm">Update</a>
                                        <a href="{{ route('DebitSource') }}"
                                            class="btn btn-info btn-rounded btn-sm">Reset</a>
                                        <a href="{{ route('admin.home') }}"
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header d-sm-flex align-items-center justify-content-between"">
                    ...
                    <h5><a href="{{ route('DebitSource') }}" title="Click here for New Debit Source">New Entry</a>
                    </h5>
                </div>
                <div class="card-body">
                    @if (!empty($Type))

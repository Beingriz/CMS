                                ...
                                <div class="col-100">
                                    ...
                                    @elseif($update)
                                        <a href="#" class="btn btn-success btn-rounded btn-sm"
                                            wire:click.prevent="UpdateLedger('{{ $transaction_id }}')">Update</button>
                                            <a href="{{ route('Debit') }}"
                                                class="btn btn-info btn-rounded btn-sm">Reset</a>
                                    @endif
                ...
                @if (count($Transactions) > 0)
                    <div class="table-responsive">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-8">
                                <p class="text-muted">Showing {{ count($Transactions) }} of

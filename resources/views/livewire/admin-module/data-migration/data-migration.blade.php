            ...
            <div class="card">
                <form wire:submit.prevent="Migrate">
                    ...
                    <div class="card-header d-sm-flex align-items-center justify-content-between"">
                        <h5>Debit Ledger</h5>
                        <h5><a href="{{ route('data.migration') }}" title="Click here for New Transaction">Data
                                Migation</a></h5>
                    </div>
                    <div class="card-body">
                        ...
                        @if ($digitalcyber)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="OldServiceList" wire:model="OldServiceList"
                                        name="OldServiceList">
                                        <option value="">---Select---</option>
                                        @foreach ($old_servicelist as $item)
                                            <option value="{{ $item->service_name }}">{{ $item->service_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="Application" wire:model="Application"
                                        name="Application">
                                        <option value="">---Select---</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="Application_Type" wire:model="Application_Type"
                        ...
                        @elseif ($debitledger)
                            {{-- Yet to Design --}}
                            <div class="row mb-3">
                                <label for="OldServiceList" class="col-sm-4 col-form-label">Debit Source</label>
                                <div class="col-sm-8">
                                    <select class="form-control" id="OldServiceList" wire:model="OldServiceList"
                                        name="OldServiceList">
                                        <option value="">---Select---</option>
                                        @foreach ($old_debitsources as $item)
                                            <option value="{{ $item->particular }}">{{ $item->particular }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="Application" wire:model="Application"
                                        name="Application">
                                        <option value="">---Select---</option>
                                        @foreach ($newDebitSources as $item)
                                            <option value="{{ $item->Id }}">{{ $item->Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="Application_Type" wire:model="Application_Type"
                                        name="Application_Type">
                                        <option value="">---Select---</option>
                                        @foreach ($subDebitSources as $item)
                                            <option value="{{ $item->Name }}">{{ $item->Name }}</option>
                                        @endforeach
                                    </select>
                                </div>

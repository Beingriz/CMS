                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-8 col-xl-7 order-2 order-lg-1">
                                    ...
                                    <p class="text-center">Unlock the Digital Universe Sign Up for Exclusive Access to
                                        the Cyber Portal!</p>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control" type="email"
                                                    placeholder="Enter your Email Id" wire:model="email" id="email">
                                                <span class="text-danger">
                                                    @error('email')
                                                        {{ $message }}
                                                    @enderror
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control" type="number"
                                                    placeholder="Enter your Mobile No" wire:model="mobile_no"
                                                    id="mobile_no">
                                                <span class="text-danger">
                                                    @error('mobile_no')
                                                        {{ $message }}

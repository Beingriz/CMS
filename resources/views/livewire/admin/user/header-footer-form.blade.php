        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Company Name"  wire:model="Company_Name" id="Company_Name">
                        <span class="error">@error('Company_Name'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Address"  wire:model="Address" id="Address">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Phone No"  wire:model="Phone_No" id="Phone_No">
                        <span class="error">@error('Phone_No'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Time From"  wire:model="Time_From" id="Time_From">
                        <span class="error">@error('Time_From'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Time To"  wire:model="Time_To" id="Time_To">
                        <span class="error">@error('Time_To'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Facebook"  wire:model="Facebook" id="Facebook">
                        <span class="error">@error('Facebook'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Twitter"  wire:model="Twitter" id="Twitter">
                        <span class="error">@error('Twitter'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Instagram"  wire:model="Instagram" id="Instagram">
                        <span class="error">@error('Instagram'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="LinkedIn"  wire:model="LinkedIn" id="LinkedIn">
                        <span class="error">@error('LinkedIn'){{$message}}@enderror</span>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">

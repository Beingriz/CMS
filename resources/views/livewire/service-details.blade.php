            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        @else
                        <img class="d-flex me-3 rounded-circle img-thumbnail avatar-lg" src="{{asset('storage/no_image.jpg')}}" alt="">
                        @endif
                        <div class="flex-grow-1">
                            ...
                            <ul class="social-links list-inline mb-0">
                                <li class="list-inline-item">
                                    <a role="button" class="text-reset" title="" data-bs-placement="top" data-bs-toggle="tooltip" href="#details" wire:click="GetDetails('{{$item->Id}}')" data-bs-original-title="Details" aria-label="Facebook"><i class="fas fa-info"></i></a>
                                </li>
                                <li class="list-inline-item">
                                    <a role="button" class="text-reset" title="" data-bs-placement="top" data-bs-toggle="tooltip" href="#showDoc" wire:click="GetDocuments('{{$item->Id}}')" data-bs-original-title="Required Documents" aria-label="Twitter"><i class="fas fa-file-archive"></i></a>
                                </li>
                                <li class="list-inline-item">
                                    <a role="button" class="text-reset" title="" data-bs-placement="top" data-bs-toggle="tooltip" href="" data-bs-original-title="Apply" aria-label="1234567890"><i class="far fa-address-card"></i></a>
                                </li>
                                <li class="list-inline-item">
            ...
            <div class="row no-gutters align-items-center">
                <div class="col-md-4">
                    @if($Image != 'Not Available')
                        ...
                        @else
                        <img class="card-img img-fluid" src="{{asset('storage/no_image.jpg')}}" alt="Card image">
                    @endif
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="table-info">
                                    <td >--</td>
                                    <td>
                                        No Documents Suggested for this Service
                                    </td>
                                </tr>
                                @endforelse

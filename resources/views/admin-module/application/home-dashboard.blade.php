                        ...
                        <div class="dashboard-insight">
                            <div class="dash-insight-sec">
                                ...
                                <div class="sec-data">
                                    ...
                                    <p class="section-pre-values"><a href="{{ url('previous_day_app') }}">Yesterday
                                            {{ $previous_day_app }}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="dash-insight-sec">
                                ...
                                <div class="sec-data">
                                    ...
                                    <p class="section-pre-values"><a href="{{ url('previous_day_new_clients') }}">Yesterday
                                            {{ $previous_day_new_clients }}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="dash-insight-sec">

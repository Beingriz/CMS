                        ...
                        <div class="data-form">
                            ...
                            <form action="{{ url('/update_credit_entry') }}/{{ $id }}" method="POST">
                                    ...
                                    <div class="col-75">
                                        <div class="md-form">
                                            <input type="date" id="date" name="Date"
                                                value="{{ $credit_info->Date }}" class="form-control" />
                                            <span class="error">
                                                @error('Date')
                                                    {{ $message }}
                                                @enderror
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <div class="md-form">
                                            <textarea id="Description" name="Description" class="form-control" rows="3" resize="none">{{ $credit_info->Description }}</textarea>
                                            <span class="error">
                                                @error('Description')
                                                    {{ $message }}
                                                @enderror

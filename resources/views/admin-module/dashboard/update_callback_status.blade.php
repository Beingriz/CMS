...
@section('admin')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ $Name }} Callback Request</h4>
            ...
            <div class="row">
                <a class="col-xl-3 col-md-6" href="{{ route('update.dashboard', 'Callback') }}" title="Callback Dashboard">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted mb-0"><span class="text-success fw-bold font-size-12 me-2"><i
                                                class="ri-arrow-right-up-line me-1 align-middle"></i>{{ $totalRequests }}</span>Requests
                                        Received till now</p>
                                </div>
                                <div class="avatar-sm">
                            ...
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted mb-0"><span class="text-danger fw-bold font-size-12 me-2"><i
                                                class="ri-arrow-right-down-line me-1 align-middle"></i>{{ $new }}</span>for
                                        Toady</p>
                                </div>
                                <div class="avatar-sm">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted mb-0"><span class="text-danger fw-bold font-size-12 me-2"><i
                                                class="ri-arrow-right-down-line me-1 align-middle"></i>{{ $percentpending }}%</span>Yet
                                        to Complete</p>
                                </div>
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-light text-primary rounded-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted mb-0"><span class="text-success fw-bold font-size-12 me-2"><i
                                                class="ri-arrow-right-up-line me-1 align-middle"></i>{{ $percentdelivered }}%</span>Completed
                                    </p>
                                </div>
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-light text-success rounded-3">
            ...
            <!-- end row -->
            @livewire('admin.admin.update-call-back-status', ['Key' => $Name, 'Id' => $Id, 'Client_Id' => $Client_Id, 'EditId' => $EditId, 'DeleteId' => $DeleteId])
